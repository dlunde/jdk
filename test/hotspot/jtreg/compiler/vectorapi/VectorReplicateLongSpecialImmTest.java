 ...
 * @run testng/othervm -XX:UseSVE=0 -XX:-TieredCompilation -XX:CompileThreshold=100 -XX:+IgnoreUnrecognizedVMOptions compiler.vectorapi.VectorReplicateLongSpecialImmTest
 */
