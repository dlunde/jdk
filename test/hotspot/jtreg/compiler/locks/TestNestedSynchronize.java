 ...
 * @test
 * @bug 8322996 8324839
 * @summary Generated test that ensures there is no assert error in C2 with
 *          deeply nested synchronize statements. NOTE: Could be made more
 *          elegant with some metaprogramming approach (e.g., template-based
 *          testing)
